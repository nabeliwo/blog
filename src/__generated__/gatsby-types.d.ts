...
type SiteSiteMetadataSocialGithubFieldSelector = {
  readonly name: InputMaybe<FieldSelectorEnum>;
...
type AllPostsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null } | null, readonly fields: { readonly slug: string | null } | null } }> } };

type FooterQueryVariables = Exact<{ [key: string]: never; }>;


type FooterQuery = { readonly site: { readonly siteMetadata: { readonly social: { readonly twitter: { readonly url: string | null } | null, readonly instagram: { readonly url: string | null } | null, readonly github: { readonly url: string | null } | null } | null } | null } | null };

type HeadQueryVariables = Exact<{ [key: string]: never; }>;


type HeadQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly image: string | null, readonly siteUrl: string | null, readonly social: { readonly twitter: { readonly name: string | null } | null } | null } | null } | null };
...
type PostQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly siteUrl: string | null } | null } | null, readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly date: string | null, readonly image: string | null, readonly tags: ReadonlyArray<string | null> | null } | null, readonly fields: { readonly slug: string | null } | null } | null };
...
type TagPostsQuery = { readonly allMarkdownRemark: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly title: string | null, readonly date: string | null } | null, readonly fields: { readonly slug: string | null } | null } }> } };
